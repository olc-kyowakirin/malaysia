$(function () {
    ...
    * ======================================== */
    (function ($) {
        ...
        var modalContentTmp = {
            type01: '<div class="box-text"><p>You will be accessing an external site.</p><p>Click "OK" to continue.</p></div><div class="align-c"><a href="{{href}}" target="_blank" class="btn-03 btn-small">OK<img src="/malaysia/share/images/icon_link_blank_04.png" alt="Open in new window" class="icon-blank"></a></div>',
